...
from keras.applications.resnet50 import preprocess_input, decode_predictions # 111
import os
...
def getresult(image_box):
    ...
    return decode
# заранее вызываем работу сети, так как работа с gpu требует времени # из-за инициализации библиотек
